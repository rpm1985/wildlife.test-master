...
public class AnimalList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Cursor cursor = AnimalListFragment.sqLiteHelper.getData("SELECT * FROM ANIMAL");
        list.clear();
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            // update
                            Cursor c = AnimalListFragment.sqLiteHelper.getData("SELECT id FROM ANIMAL");
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    AnimalListFragment.sqLiteHelper.updateData(
                            edtName.getText().toString().trim(),
                            edtDescription.getText().toString().trim(),
                            AnimalListFragment.imageViewToByte(imageViewAnimal),
                            position
                    );
                    dialog.dismiss();
    ...
    private void showDialogDelete(final int idAnimal){
        ...
        dialogDelete.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    AnimalListFragment.sqLiteHelper.deleteData(idAnimal);
